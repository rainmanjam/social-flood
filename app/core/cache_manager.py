...
async def get_from_cache(key: str, namespace: Optional[str] = None, default: Any = None) -> Any:
    """
    Get a value from the cache.
...
async def set_in_cache(key: str, value: Any, ttl: Optional[int] = None, namespace: Optional[str] = None) -> bool:
    """
    Set a value in the cache.
...
async def delete_from_cache(key: str, namespace: Optional[str] = None) -> bool:
    """
    Delete a value from the cache.
...
def cached(
    ttl: Optional[int] = None, namespace: Optional[str] = None, key_builder: Optional[Callable[..., str]] = None
):
    """
    Decorator for caching function results.
